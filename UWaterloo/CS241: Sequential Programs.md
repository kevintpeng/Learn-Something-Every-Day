...
- *a regular grammar often (maybe always?) describes a language describable by a regular expression*
- recall stochastic describes something that is randomly determined, having random probability distribution
- given a probability space (omega, F, P) and a measurable space (S, ∑)
