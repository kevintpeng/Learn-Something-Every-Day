...
- roughly two classes of decidable languages were presented: 1. ones where we simulate the encoded DFA or equivalent, and ones where we look at the language for the DFA
